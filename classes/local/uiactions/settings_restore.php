 ...
 */
class settings_restore extends base {
    ...
    public function display(\renderer_base $output) {
        return $output->heading(get_string('restoresettingsheader', 'tool_vault'), 3) .
     ...
     */
    public function get_form(): restore_settings_form {
        if ($this->form === null) {
            $this->form = new restore_settings_form(true);
        }
        return $this->form;
    }
