 ...
 */
class settings_general extends base {
    ...
    public function display(\renderer_base $output) {
        return $output->heading(get_string('generalsettingsheader', 'tool_vault'), 3) .
     ...
     */
    public function get_form(): general_settings_form {
        if ($this->form === null) {
            $this->form = new general_settings_form(true);
        }
        return $this->form;
    }
}
