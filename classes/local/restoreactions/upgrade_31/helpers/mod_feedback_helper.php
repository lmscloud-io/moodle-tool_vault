...
class mod_feedback_helper {
     ...
     */
    public static function mod_feedback_upgrade_courseid($tmp = false) {
        global $DB;
        $suffix = $tmp ? 'tmp' : '';
     ...
     * @param bool $tmp use for temporary table
     */
    public static function mod_feedback_upgrade_delete_duplicate_values($tmp = false) {
        global $DB;
        $suffix = $tmp ? 'tmp' : '';
