...
function tool_vault_27_xmldb_assignment_upgrade($oldversion) {
    global $CFG, $DB, $OUTPUT;

    // TODO this upgrade script will be skipped because folder for mod_assignment no longer exists
    // but I need to copy assignment->assign script eventually.
    require_once($CFG->dirroot .'/mod/assignment/db/upgradelib.php'); // TODO no requires
