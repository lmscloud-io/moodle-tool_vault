...
/**
 * All upgrade scripts between 4.2.3 (2023042403.00) and 4.5.10 (2024100710.00)
 *
 * @package    tool_vault
...
function tool_vault_405_core_upgrade($oldversion) {
    ...
    if ($oldversion < 2024100100.02) {
        tool_vault_405_upgrade_store_relative_url_sitehomepage();
 ...
 */
function tool_vault_405_upgrade_store_relative_url_sitehomepage() {
    global $CFG, $DB;
