 ...
 * @return bool result
 */
function tool_vault_36_xmldb_auth_manual_upgrade($oldversion) {
    global $CFG;
    ...
    if ($oldversion < 2017020700) {
        ...
        auth_helper::upgrade_fix_config_auth_plugin_names('manual');
        auth_helper::upgrade_fix_config_auth_plugin_defaults('manual');
