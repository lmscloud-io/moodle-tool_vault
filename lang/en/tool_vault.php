...
$string['lastop_restorefailed_canberesumed'] = 'This restore can be resumed.';
...
$string['pathnotwritable_help'] = 'Tool vault either can not write to the codebase or it is prohibited in the settings.';
...
$string['resumerestore'] = 'Resume this restore';
$string['resumerestore_desc'] = 'Restore will resume on the next cron run';
