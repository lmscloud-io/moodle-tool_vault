...
$string['moodleversion_success_withextraupgrade'] = 'Restore can be performed. Vault will upgrade the site to {$a->intermediaryrelease} as part of the restore process. After restore is completed you will need to run Moodle upgrade process. Moodle by itself can not upgrade from {$a->backuprelease} to {$a->currentrelease}. See <a href="{$a->url}">environment page</a> for upgrade requirements.';
...
$string['restoreremovemissing_desc'] = "If a backup contains data for plugins that are not present in this site codebase, they will be marked as \"Missing from disk\" in the plugin overview.<br>
