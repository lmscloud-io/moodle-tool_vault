...
- This is the **3.9.x** series, maintained in the `MOODLE_39_STABLE` branch, and it currently
  supports Moodle 3.9 to 5.1.
- On Moodle 4.5 and newer, install the latest release of the **4.5.x** series instead, which
  currently supports Moodle 4.5 to 5.2.
